	...
	<div id="panel">
		...
		<content>
			<ul>
				...
				<li><a href="box.html">Сундуки</a></li>
				<li><a href="payments.html">Выплаты</a></li>
				<li><a href="#">Правила</a></li>
			</ul>	
		</content>
	</div>
	<div class="center">
		<h4>Для того чтобы получить бонус войдите в систему</h4>
		<form action="#" method="POST" id="form_log"> 
			<input type="text" value="P" id="payer"><br>
			<input type="password" id="password" placeholder="Пароль"><br>
			<input type="submit" id="submit" value="Получить">
		</form>
		<div class="reklama">
